...
class EnvBase(gym.Env):
    ...
    def integrate_root_translation(self, pose):     # pose : next_frame
    ...
    def get_cond_frame(self):
        ...
        # print("history", self.history.shape)    # history torch.Size([512, 5, 267])
        return condition
    ...
    def step(self, action):
        ...
        # print("next_frame",next_frame.shape)    ### next_frame torch.Size([1, 267])
